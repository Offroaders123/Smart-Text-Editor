      ...
      <div class="main">
        <div class="content">
          <div class="item list start">
            ...
            <div class="checkbox">
              <input id="syntax_highlighting_setting" type="checkbox" oninput={event => { STE.appearance.setSyntaxHighlighting((event.currentTarget! as HTMLInputElement).checked); }}/>
              <label htmlFor="syntax_highlighting_setting"><svg class="check"><use href="#check_icon"/></svg>Syntax Highlighting (Beta)</label>
            </div>
            <div class="checkbox">
              <input id="automatic_refresh_setting" type="checkbox" oninput="STE.settings.automaticRefresh = this.checked;" checked/>
              <label htmlFor="automatic_refresh_setting"><svg class="check"><use href="#check_icon"/></svg>Automatically Refresh Preview</label>
            </div>
          </div>
        </div>
        <div class="options">
    ...
    <ste-card id="color_picker_card" type="widget">
      ...
      <div class="main">
        <div class="content">
          ...
          <div class="item list">
            <label htmlFor="red_channel">Red</label>
            <input id="red_channel" type="range"/>
            <label htmlFor="green_channel">Green</label>
            <input id="green_channel" type="range"/>
            <label htmlFor="blue_channel">Blue</label>
      ...
      <div class="main">
        ...
        <div class="options">
          <div class="checkbox">
            ...
            <label htmlFor="encoder_type"><svg class="check"><use href="#check_icon"/></svg>Enable URI Component</label>
          </div>
        </div>
      </div>
    </ste-card>
